...
def handle_high_command(user_input):
    # Парсинг пользовательского ввода
    parts = user_input.split()
    if len(parts) != 3:
        return "Неправильный формат команды. Используйте: /high <товар> <количество>"
    ...
    # Вывод результатов
    result = f"Товары '{product_type}' отсортированные по убыванию цены:\n"
